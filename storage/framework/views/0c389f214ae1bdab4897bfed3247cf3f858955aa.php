                         ...
                         <div class="box-body">
                            <?php echo Form::open(array('url' =>'admin/addNewCustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <?php echo Form::text('email',  '', array('class'=>'form-control email-validate', 'id'=>'customers_email_address')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <?php echo Form::password('password', array('class'=>'form-control field-validate', 'id'=>'customers_password')); ?>
