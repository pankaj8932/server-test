...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('labels.themeSetting')); ?><small><?php echo e(trans('labels.themeSetting')); ?>...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
      <li class="active"><?php echo e(trans('labels.themeSetting')); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.themeSetting')); ?></h3>
          </div>
                         ...
                         <div class="box-body">
                            ...
                            <div class="row"> 
                            	<div class="col-md-3 col-xs-6">
                                    ...
                                    <?php if($result['settings'][71]->value == '1'): ?>
                                        checked
                                    <?php endif; ?>
                                    value="1"> <?php echo e(trans('labels.Style1')); ?>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <?php echo e(trans('labels.coming_soon')); ?>
