...
<section class="site-content">
    <div class="container">
        <div class="breadcum-area">
            <div class="breadcum-inner">
                ...
                <ol class="breadcrumb">                    
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/myorders')); ?>"><?php echo app('translator')->getFromJson('website.My Orders'); ?></a></li>
        ...
        <div class="orders-detail-area">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 card-box">
                    <div class="card">
