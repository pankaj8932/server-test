<div class="modal-header">
  ...
  <?php echo Form::open(array('url' =>'admin/deleteattributeform', 'name'=>'deleteattributeform', 'id'=>'deleteattributeform', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
