		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="<?php echo e(URL::to('/signupProcess')); ?>" method="post">
					...
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label"><?php echo app('translator')->getFromJson('website.Last Name'); ?></label>
						<div class="col-sm-8">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select class="custom-select mr-sm-2 gender-validation" name="gender" id="inlineFormCustomSelect">
								...
								<option value="0"><?php echo app('translator')->getFromJson('website.Male'); ?></option>
								<option value="1"><?php echo app('translator')->getFromJson('website.Female'); ?></option>
							</select>
					...
					<div class="form-group row">
						<label for="inputPassword4" class="col-sm-4 col-form-label"><?php echo app('translator')->getFromJson('website.Password'); ?></label>
						<div class="col-sm-8">
					...
					<div class="form-group row">					
						<label for="inputPassword5" class="col-sm-4 col-form-label"><?php echo app('translator')->getFromJson('website.Confirm Password'); ?></label>
						...
						<div class="col-sm-8">
							<div class="form-check checkbox-parent">
								<label class="form-check-label ">
									<input class="form-check-input checkbox-validate" type="checkbox"><?php echo app('translator')->getFromJson('website.Creating an account means you are okay with our'); ?>  <a href="<?php echo e(URL::to('/termsAndCondtions')); ?>"><?php echo app('translator')->getFromJson('website.Terms and Services'); ?></a>, <a href="<?php echo e(URL::to('/privacyPolicy')); ?>"><?php echo app('translator')->getFromJson('website.Privacy Policy'); ?></a> and <a href="<?php echo e(URL::to('/refundPolicy')); ?>"><?php echo app('translator')->getFromJson('website.Refund Policy'); ?></a>.
								</label>
