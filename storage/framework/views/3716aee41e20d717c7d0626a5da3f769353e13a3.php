                         ...
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateCustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                   <?php echo Form::hidden('old_email_address',  $data['customers'][0]->email, array('class'=>'form-control', 'id'=>'old_email_address')); ?>
                                    ...
                                    <?php echo Form::email('email',  $data['customers'][0]->email, array('class'=>'form-control email-validate', 'id'=>'customers_email_address')); ?>
                                ...
                                <!--<div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control" name="change_password" id="change_password" onChange="changePassword()">
                               ...
                               <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="password" name="password" value="<?php echo e($data['customers'][0]->password); ?>" class="form-control field-validate" id="customers_password"> 
