...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><?php echo e(trans('labels.dashboard_Version')); ?> 1.0</small>
      </h1>
      <ol class="breadcrumb">
...
<?php echo $__env->make('themes.admin.layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>