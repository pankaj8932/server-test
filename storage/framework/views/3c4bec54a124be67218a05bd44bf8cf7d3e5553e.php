              ...
              <div id="owl_special" class="owl-carousel"> <?php if($result['special']['success']==1): ?>
                ...
                <div class="product">
                  <article>
                    ...
                    <h2 class="title"><?php echo e($special->products_name); ?></h2>
                ...
                <div class="product">
                  <article>
				   ...
				   ?>
                    ...
                    <h2 class="title"><?php echo e($most_liked->products_name); ?></h2>
                    <!--<p class="like">
...
<section class="blog-content"> <?php echo $__env->make('common.blog', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </section>
