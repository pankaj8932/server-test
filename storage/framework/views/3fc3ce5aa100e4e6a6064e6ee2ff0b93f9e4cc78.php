                ...
                <div class="row">
                     ...
                     <div class="col-12 col-lg-9">
                                            ...
                                            <article>
                                                <div class="blog-thumb">
                                                    <?php if($news_data->is_feature==1): ?>
                                                        <span class="badge badge-pill"><?php echo app('translator')->getFromJson('website.Featured'); ?></span>
                                                    <?php endif; ?>
                                 ...
                                 <div class="toolbar mt-3">
                                    <div class="form-inline">                                    
                                        <div class="form-group  justify-content-start col-6">
                                            ...
                                            <label for="staticEmail" class="col-form-label"><?php echo app('translator')->getFromJson('website.Showing 1–'); ?><span class="showing_record"><?php echo e($result['limit']); ?> </span>
                        ...
                        <?php /*?><div class="load-more-area">
                            ...
                            <p id="loaded_content" @if( $result['news']['success']==1 and count($result['news']['news_data']) < $record) style="display:block" @else style="display:none;" @endif >
                            	@lang('website.All news are loaded')
                            </p>
                            
                            <p id="loaded_content_empty" @if($result['news']['success']==0) style="display:block" @else style="display:none;" @endif >
