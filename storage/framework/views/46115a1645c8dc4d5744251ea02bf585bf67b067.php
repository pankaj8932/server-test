                        ...
                        <div class="col-12 spaceright-0">
                        	<div class="row">
                                ...
                                <?php /*?><div class="load-more-area">
                                    ...
                                    <p id="loaded_content" @if( $result['products']['success']==1 and count($result['products']['product_data']) < $record) 
                                        style="display:block"
                                    @else
                                        style="display:none;"
                                    @endif  
                                    >@lang('website.All products are loaded')</p>
                                    
                                    <p id="loaded_content_empty" @if($result['products']['success']==0)
                                        style="display:block" 
                                    @else
                                        style="display:none;"
                                    @endif  
                                    
                                    >@lang('website.No record found')</p>
                                </div><?php */?>
                            </div>
                        </div>
                    </div>
