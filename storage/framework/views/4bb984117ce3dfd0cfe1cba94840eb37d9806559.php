    	...
    	<div class="breadcum-area">
        	<div class="breadcum-inner">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/shop?categories_id='.$result['detail']['product_data'][0]->categories_id)); ?>"><?php echo e($result['detail']['product_data'][0]->categories_name); ?></a></li>
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="product-summary">
                                    ...
                                    <div class="product-info">
                                        <a href="<?php echo e(URL::to('/shop?categories_id='.$result['detail']['product_data'][0]->categories_id)); ?>" class="category" ><?php echo e($result['detail']['product_data'][0]->categories_name); ?></a>
                                    ...
                                    <?php /*?><div class="cat">
                                        <strong>@lang('website.Categories'):</strong>&nbsp;
                                        <a href="{{ URL::to('/shop?categories_id='.$result['detail']['product_data'][0]->categories_id)}}">
                                            {{$result['detail']['product_data'][0]->categories_name}}
                                        </a>
                                    </div>
                                    <div class="like">
                                        <span products_id = '{{$result['detail']['product_data'][0]->products_id}}' class="fa @if($result['detail']['product_data'][0]->isLiked==1) fa-heart @else fa-heart-o @endif is_liked"></span>  
                                        <span>{{$result['detail']['product_data'][0]->products_liked}}&nbsp;@lang('website.Likes')</span>
                                    </div>
                                    <div class="product-orders">
                                        <span>{{$result['detail']['product_data'][0]->products_ordered}}&nbsp;@lang('website.Order(s)')</span>                                	
                                    </div>
                                    ...
                                    <div class="description">
                                        <h4>@lang('website.Products Description')</h4>
                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty">	
                                                ...
                                                <div class="input-group">						
                                                    ...
                                                    <input type="text" name="quantity" value="<?php echo e($result['cart'][0]->customers_basket_quantity); ?>" class="form-control qty">						
                                            ...
                                            <div class="buttons">
                                                ...
                                                <?php else: ?>
                                                    <button class="btn btn-secondary btn-round add-to-Cart" type="button" products_id="<?php echo e($result['detail']['product_data'][0]->products_id); ?>"><?php echo app('translator')->getFromJson('website.Update'); ?></button>
                                                <?php endif; ?> 
                                            </div>					
                                    	</div>	
									</form>
