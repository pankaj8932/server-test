...
<section class="site-content">
	<div class="container">
        ...
        <div class="my-shipping-area">
            <div class="row">    
                <div class="col-xs-12 col-sm-12 col-md-7 my-shipping">
                    <h5 class="title-h5"><?php echo app('translator')->getFromJson('website.Shipping Address'); ?></h5>
                    	...
                    	<table class="table table-hover">
                          ...
                          <?php $__currentLoopData = $result['address']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              ...
                              <td align="left"><a class="badge badge-light" href="<?php echo e(URL::to('/myAddress?address_id='.$address_data->address_id)); ?>"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
