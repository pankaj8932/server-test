...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/listingProducts')); ?>"><i class="fa fa-database"></i><?php echo e(trans('labels.ListingAllProducts')); ?></a></li>
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="box-footer text-center">
				<a href="<?php echo e(URL::to("admin/listingProducts")); ?>" class="btn btn-primary"><?php echo e(trans('labels.SaveUpdate')); ?></a>
			</div>
          </div>
