...
<nav id="navbar" class="navbar navbar-expand-lg py-0 mb-3 bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      ...
      <ul class="navbar-nav"> 
        ...
        <li class="nav-item dropdown open">
        	<a class="nav-link dropdown-toggle" href="" id="navbarDropdownMenuLink00" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo app('translator')->getFromJson('website.homePages'); ?></a>
        ...
        <li class="nav-item dropdown mega-dropdown open">
          <a href="" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row" aria-labelledby="navbarDropdownMenuLink02">
            <li class="col-sm-3">
              <ul>
                <li class="dropdown-header"><?php echo app('translator')->getFromJson('website.new in Stores'); ?></li>
                <?php if($result['commonContent']['recentProducts']['success']==1): ?>
                    ...
                    <?php $__currentLoopData = $result['commonContent']['recentProducts']['product_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="carousel-item <?php if($key==0): ?> active <?php endif; ?>">
                          <a href="<?php echo e(URL::to('/productDetail/'.$products->products_id)); ?>"><img src="<?php echo e(asset('').$products->products_image); ?>" alt="<?php echo e($products->products_name); ?>" class="img-responsive"></a>
            ...
            <li class="col-sm-9 row">
            <?php $__currentLoopData = $result['commonContent']['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            	
                  <ul class="col-sm-4">
                        
                    <li class="dropdown-header"><a href="<?php echo e(URL::to('/shop')); ?>?category_id=<?php echo e($categories_data->id); ?>"><?php echo e($categories_data->name); ?></a></li>
                      <?php if(count($categories_data->sub_categories)>0): ?>
                         <?php $__currentLoopData = $categories_data->sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_categories_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(URL::to('/shop')); ?>?category_id=<?php echo e($sub_categories_data->sub_id); ?>"><?php echo e($sub_categories_data->sub_name); ?></a></li>              		
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                      <?php endif; ?> 
        ...
        <li class="nav-item dropdown open">
        	<a href="" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo app('translator')->getFromJson('website.infoPages'); ?></a>
        ...
        <!--<li class="nav-item last"><a class="nav-link"><span>Hotline</span>(888 9436 6000)</a></li>-->
      </ul>
    </div>
  </div>
</nav>
