                        ...
                        <!-- form start -->                        
                         <div class="box-body">
							...
							<div class="form-group">
								<label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.UnitName')); ?></label>
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('unit_name',  '', array('class'=>'form-control field-validate', 'id'=>'unit_name')); ?>

                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                    <?php echo e(trans('labels.UnitNameMessage')); ?></span>
							...
							<div class="box-footer text-right">
                            	<div class="col-sm-offset-2 col-md-offset-3 col-sm-10 col-md-4">
                                    <button type="submit" class="btn btn-primary"><?php echo e(trans('labels.AddUnit')); ?></button>
