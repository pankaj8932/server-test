                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="type" id="bannerType">
                                          ...
                                          <option value="product" <?php if($result['sliders'][0]->type=='product'): ?> selected <?php endif; ?>>Product</option>
                                          <option value="top seller" <?php if($result['sliders'][0]->type=='top seller'): ?> selected <?php endif; ?>>Top Seller</option>
                                          <option value="deals" <?php if($result['sliders'][0]->type=='deals'): ?> selected <?php endif; ?>>Deals</option>
                                          <option value="most liked" <?php if($result['sliders'][0]->type=='most liked'): ?> selected <?php endif; ?>>Most Liked</option>
                                      </select>
