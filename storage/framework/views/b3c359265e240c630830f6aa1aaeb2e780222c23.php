							...
							<?php $__currentLoopData = $result['products_attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$products_attributes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($products_attributes->is_default == '1'): ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($products_attributes->products_options_name); ?></td>
                                        <td><?php echo e($products_attributes->products_options_values_name); ?></td>
                                        <!--<td><?php echo e($products_attributes->price_prefix); ?><?php echo e($products_attributes->options_values_price); ?></td>-->
                                        <td>
                                            <a class="badge bg-light-blue editDefaultAttributeModal" products_id = '<?php echo e($products_attributes->products_id); ?>' products_attributes_id = "<?php echo e($products_attributes->products_attributes_id); ?>" language_id = "<?php echo e($products_attributes->language_id); ?>" options_id = '<?php echo e($products_attributes->options_id); ?>' ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                          ...
                          <div class="form-group">
							  ...
							  <div class="col-sm-10 col-md-8">
								  <select class="form-control language_id" name="languages_id">		
                                  	<option value="" class="field-validate"><?php echo e(trans('labels.ChooseLanguage')); ?></option>								 
                              	...
                              	<?php echo e(trans('labels.Chooselagnuage')); ?></span>
                          ...
                          <div class="form-group">
						   ...
						   <div class="form-group">
							  ...
							  <div class="col-sm-10 col-md-8">
								  <select class="form-control products_options_values_id field-validate" name="products_options_values_id">										 
									 <!--<?php $__currentLoopData = $result['options_value']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $options_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									  <option value="<?php echo e($options_value->products_options_values_id); ?>"><?php echo e($options_value->products_options_values_name); ?></option>
									 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	-->									 
								  </select>
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
							...
							<!--<div class="form-group">
							  ...
							  <div class="col-sm-10 col-md-8">
								 <?php echo Form::text('price_prefix',  '+', array('class'=>'form-control', 'id'=>'price_prefix')); ?>
                            ...
                            <div class="alert alert-danger addDefaultError" style="display: none; margin-bottom: 0;" role="alert"><i class="icon fa fa-ban"></i><?php echo e(trans('labels.AddOptionErrorText')); ?> </div>
                      </div>
...
<div class="row">
      <div class="col-md-12">
                  		...
                  		<?php if(count($result['products_attributes']) > 0): ?>
							<?php $__currentLoopData = $result['products_attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$products_attributes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($products_attributes->price_prefix); ?><?php echo e($products_attributes->options_values_price); ?></td>
                                    <td>
                                       <a class="badge bg-light-blue editProductAttributeModal" products_id = '<?php echo e($products_attributes->products_id); ?>' products_attributes_id = "<?php echo e($products_attributes->products_attributes_id); ?>" language_id = "<?php echo e($products_attributes->language_id); ?>" options_id = '<?php echo e($products_attributes->options_id); ?>' ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
					...
					<div class="modal-content">
                      ...
                      <div class="form-group">
							  ...
							  <div class="col-sm-10 col-md-8">
                              	...
                              	<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                              	<?php echo e(trans('labels.ChooseLanguage')); ?></span>
							  ...
							  <div class="col-sm-10 col-md-8">
								  <select class="form-control  additional-option-id field-validate" name="products_options_id">										 
									 <!--<?php $__currentLoopData = $result['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									  <option value="<?php echo e($options->products_options_id); ?>"><?php echo e($options->products_options_name); ?></option>
									 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->										 
						   ...
						   <div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-10 col-md-8">
                                 ...
                                 <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                 <?php echo e(trans('labels.PricePrefixText')); ?></span>
							  </div>
							</div>
                            ...
                            <?php echo e(trans('labels.OpitonExistText')); ?></div>
                      </div>
					  <div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('labels.Close')); ?></button>
        ...
        <div class="box-footer text-center">
				<a href="<?php echo e(URL::to("admin/addProductImages/{$result['data']['products_id']}")); ?>" class="btn btn-primary"><?php echo e(trans('labels.AddImages')); ?></a>
                <a href="<?php echo e(URL::to("admin/listingProducts")); ?>" class="btn btn-success"><?php echo e(trans('labels.Complete')); ?></a>
			</div>
        </div>
        <!-- /.box --> 
      </div>
