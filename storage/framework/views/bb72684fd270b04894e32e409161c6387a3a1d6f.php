    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      ...
      <ul class="navbar-nav"> 
        ...
        <li class="nav-item dropdown open">
        	<a class="nav-link dropdown-toggle" href=""  aria-expanded="false"><?php echo app('translator')->getFromJson('website.homePages'); ?></a>
                ...
                <?php if($result['commonContent']['recentProducts']['success']==1): ?>
                    ...
                    <?php $__currentLoopData = $result['commonContent']['recentProducts']['product_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="carousel-item <?php if($key==0): ?> active <?php endif; ?>">
                          ...
                          <span class="btn btn-default" ><span products_id = '<?php echo e($products->products_id); ?>' class="fa <?php if($products->isLiked==1): ?> fa-heart <?php else: ?> fa-heart-o <?php endif; ?> is_liked"></span> </span>
                        </div>
                        <!-- End Item -->
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <li class="nav-item dropdown open">
        	<a class="nav-link dropdown-toggle" href="<?php echo e(URL::to('/news/')); ?>" aria-expanded="false"><?php echo app('translator')->getFromJson('website.News'); ?></a>
            ...
            <?php $__currentLoopData = $result['commonContent']['newsCategories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             	
                <li>                
                	<a class="dropdown-item" href="<?php echo e(URL::to('/news?category_id='.$categories->id)); ?>"><?php echo e($categories->name); ?></a>                 
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          	</ul>    
        </li>
        <li class="nav-item dropdown open">
        	<a href="" class="nav-link dropdown-toggle" aria-expanded="false"><?php echo app('translator')->getFromJson('website.infoPages'); ?></a>
