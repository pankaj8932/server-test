 	...
 	<form enctype="multipart/form-data" name="filters" method="post">
        ...
        <div class="card first">
			<div class="card-header" id="headingOne">
				<a data-toggle="collapse" href="#collapseAccordian1" aria-expanded="true" aria-controls="collapseAccordian1">
					Price
				</a>
			</div>
			<div id="collapseAccordian1" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
				<div class="card-body">
        ...
        <?php $__currentLoopData = $result['filters']['attr_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$attr_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card <?php if(count($result['filters']['attr_data'])==$key+1): ?> last <?php endif; ?>">
                <div class="card-header" role="tab" id="heading_<?=$key?>">
                    <a data-toggle="collapse" href="#collapseAccordian_<?=$key?>" aria-expanded="true" aria-controls="#collapseAccordian_<?=$key?>">
                      <?php echo e($attr_data['option']['name']); ?>

                    </a>
                </div>
                
                <div id="collapseAccordian_<?=$key?>" class="collapse show" role="tabpanel" aria-labelledby="heading_<?=$key?>" data-parent="#accordion">
                    <div class="card-body">
                        <ul class="list">
		...
		<?php endif; ?>
		<div class="button">
        	<a href="shop" class="btn btn-dark" id="apply_options"> <?php echo app('translator')->getFromJson('website.Reset'); ?> </a>
