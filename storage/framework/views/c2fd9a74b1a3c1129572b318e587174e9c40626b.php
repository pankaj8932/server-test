			...
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="<?php echo e(URL::to('/signupProcess')); ?>" method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select class="custom-select mr-sm-2 field-validate" name="gender" id="inlineFormCustomSelect">
								<option selected value=""><?php echo app('translator')->getFromJson('website.Choose...'); ?></option>
								<option value="0" <?php if(old('email')==0): ?> selected <?php endif; ?>)><?php echo app('translator')->getFromJson('website.Male'); ?></option>
								<option value="1" <?php if(old('email')==1): ?> selected <?php endif; ?>><?php echo app('translator')->getFromJson('website.Female'); ?></option>
							</select>
						...
						<div class="col-sm-8">
							<div class="form-check checkbox-parent">
								<label class="form-check-label">
									<input class="form-check-input checkbox-validate" type="checkbox"><?php echo app('translator')->getFromJson('website.Creating an account means you are okay with our'); ?>  <a href="<?php echo e(URL::to('/page?name='.$result['commonContent']['pages'][3]->slug)); ?>"><?php echo app('translator')->getFromJson('website.Terms and Services'); ?></a>, <a href="<?php echo e(URL::to('/page?name='.$result['commonContent']['pages'][1]->slug)); ?>"><?php echo app('translator')->getFromJson('website.Privacy Policy'); ?></a> and <a href="<?php echo e(URL::to('/page?name='.$result['commonContent']['pages'][2]->slug)); ?>"><?php echo app('translator')->getFromJson('website.Refund Policy'); ?></a>.
								</label>
