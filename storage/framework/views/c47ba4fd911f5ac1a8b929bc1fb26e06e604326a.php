...
<span> <?php echo e(trans('labels.link_app_settings')); ?></span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview <?php echo e(Request::is('admin/facebookSettings') ? 'active' : ''); ?> <?php echo e(Request::is('admin/setting') ? 'active' : ''); ?> <?php echo e(Request::is('admin/googleSettings') ? 'active' : ''); ?> ">
          <a href="#">
            <i class="fa fa-gears" aria-hidden="true"></i>
