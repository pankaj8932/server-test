...
<section class="site-content">
	<div class="container">
		...
		<div class="product-detail-area">
								<?php //print("<pre>".print_r($result['detail']['product_data'][0],true)."</pre>");?>
			<div class="row">
				<div class="col-12">
                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty">
                                                ...
                                                <div class="input-group">						
                                                    ...
                                                    <input type="text" name="quantity" value="1" min="1" max="<?php echo e($result['detail']['product_data'][0]->products_quantity); ?>" class="form-control qty">						
