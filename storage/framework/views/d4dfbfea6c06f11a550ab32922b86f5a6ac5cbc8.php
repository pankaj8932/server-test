...
<div class="registration-area">
	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-6 col-lg-7 new-customers">
			...
			<p class="text-center"><?php echo app('translator')->getFromJson('website.Dont have account'); ?> <a href="<?php echo e(URL::to('/signup')); ?>" class="blue-text ml-1"><b><?php echo app('translator')->getFromJson('website.Sign Up'); ?></b></a></p>
		...
		<div class="col-12 col-md-6 col-lg-5 registered-customers">
			...
			<form name="signup" enctype="multipart/form-data" class="form-validate"  action="<?php echo e(URL::to('/customerLogin')); ?>" method="post">
				...
				<div class="button">
                	<a href="<?php echo e(URL::to('/forgotPassword')); ?>" class="blue-text ml-1 mr-4"><?php echo app('translator')->getFromJson('website.Forgot Password'); ?></a>
