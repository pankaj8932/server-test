<?php  $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group">
                    <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.feature')); ?> </label>
                    <div class="col-sm-10 col-md-4">
                      <select class="form-control" name="is_feature">
                        <option
                                               <?php if($result['product'][0]->is_feature == 1 ): ?>
                                                 selected  
                                               <?php endif; ?> 
                                               value="1"><?php echo e(trans('labels.Yes')); ?>

                                               </option>
                         <option
                                               <?php if($result['product'][0]->is_feature == 0 ): ?>
                                                 selected 
                                               <?php endif; ?> 
                                               value="0"><?php echo e(trans('labels.No')); ?></option>
                      </select>
                         <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        <?php echo e(trans('labels.featureText')); ?>.</span>
                    </div>
                  </div>
