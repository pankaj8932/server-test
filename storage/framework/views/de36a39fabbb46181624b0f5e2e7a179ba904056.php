...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to("admin/attributes")); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.ListingOptions')); ?></a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.Edit Options Value')); ?></h3>
          </div>
