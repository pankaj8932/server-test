<?php  $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <?php endif; ?>
                            ...
                            <div class="form-group">
                              <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.themesLabel')); ?>

                              
                              </label>
                              <div class="col-sm-10 col-md-4">
                              <select name="themes" class="form-control">
                              	<option <?php if($result['setting'][0]->themes == 'themeone'): ?>
                                        selected
                                    <?php endif; ?>
                                 value="themeone"> <?php echo e(trans('labels.theme1')); ?></option>
                                <option <?php if($result['setting'][0]->themes == 'themetwo'): ?>
                                        selected
                                    <?php endif; ?>
                                 value="themetwo"> <?php echo e(trans('labels.theme2')); ?></option>                                
                                         
                               </select>
                                
                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;"><?php echo e(trans('labels.themesLabelText')); ?></span>
                              </div>
                            </div>
