...
<section class="site-content">
	<div class="container">
    	...
    	<div class="shop-area">
        	...
        	<div class="row">
                <form method="get" enctype="multipart/form-data" id="load_wishlist_form">
                ...
                <input type="hidden"  name="type" value="wishlist">
                    ...
                    <div class="col-12">
                        ...
                        <div class="load-more-area">
                            ...
                            <p id="loaded_content" <?php if( $result['products']['success']==1 and count($result['products']['product_data']) < $record): ?> style="display:block" <?php else: ?> style="display:none;" <?php endif; ?> ><?php echo app('translator')->getFromJson('website.All products are loaded'); ?></p>
